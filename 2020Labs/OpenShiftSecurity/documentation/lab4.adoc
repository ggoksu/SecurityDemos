...
* Red Hat OpenShift console - https://console-openshift-console.apps.{GUID}.example.opentlc.com
+
*login:* {USERID}
+
*password:* openshift
...
* Sonarqube - https://sonarqube-ocp-workshop.apps.{GUID}.example.opentlc.com
+
no login necessary
+
