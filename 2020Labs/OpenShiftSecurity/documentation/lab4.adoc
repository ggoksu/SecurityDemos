...
+
* Gogs - http://gogs-ocp-workshop.apps.cluster-{GUID}.{GUID}.example.opentlc.com
+
*login:* {USERID}
+
*password:* openshift
...
* Jenkins - https://jenkins-{USERID}.apps.cluster-{GUID}.{GUID}.example.opentlc.com
...
* Nexus - http://nexus-ocp-workshop.apps.cluster-{GUID}.{GUID}.example.opentlc.com
+
no login necessary
+
image:images/lab7.2-nexus.png[]
* Sonarqube - https://sonarqube-ocp-workshop.apps.cluster-{GUID}.{GUID}.example.opentlc.com
+
no login necessary
+
image:images/lab7.2-sonarqube.png[]

* Quay - http://quayecosystem-quay-quay-enterprise.apps.cluster-{GUID}.{GUID}.example.opentlc.com
+
**login:** admin
+
**password:** admin123
...
+
. Navigate to the SonarQube url https://sonarqube-ocp-workshop.apps.{GUID}.example.opentlc.com Click on the number link above *Projects Analyzed* section:
+
